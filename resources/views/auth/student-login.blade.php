...
@section('content')
    ...
    <section id="page-content-wrap">
                            ...
                            <div class="col-lg-10 m-auto">
                                <div class="register-form-content">
                                    <div class="row">
                                        ...
                                        <div style="background-color: teal;color: white" class="col-lg-7 text-center col-md-6 ml-auto">
                                            <br>
        ...
        <div style="background-color: teal;color: white" id="register-student" class="register-form-wrap fadeInLeft  modal">

            ...
            <div class="row">
                <div class="col-lg-8 m-auto text-center">
                    <div class="page-title-content">
                        ...
                        <a href="#page-content-wrap" class="btn btn-brand smooth-scroll bg-danger">Let's See</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="register-page-inner">
                            <div class="col-lg-10 m-auto">
                                <div class="register-form-content">
                                    <div class="row">
                                        ...
                                        <div style="background-color: dodgerblue;color: white" class="col-lg-7 col-md-6 ml-auto">
                                            <br>
                            ...
                            <div style="background-color: teal;color: white" id="register-admin" class="register-form-wrap modal">

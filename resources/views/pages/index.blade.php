                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="slider-content">
                                <h2>Refresh</h2>
                                <h3>The Old Times. <span style="color: teal !important;">Be A Part Where You’ve Grown Apart.</span></h3>
                        ...
                        <div class="upcoming-event-content owl-carousel">
                            ...
                            <!-- partial -->
                                ...
                                <div class="alert alert-danger" role="alert">
                                    <p class="text-center">No latest events found.</p>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 ml-auto">
                        <div class="about-content-wrap">
                            ...
                            <a href="/about" class="btn btn-brand about-btn">more...</a>
                        </div>
                    </div>
                </div>
            </div>

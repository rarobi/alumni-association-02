...
<header id="header-area">
    <div class="preheader-area" style="background-color: black;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-7 col-7">
                    <div class="preheader-left">
                        <a href="mailto:info@nstu.edu.bd"><i class="fa fa-envelope"></i> info@nstu.edu.bd</a>
    ...
    <div style="background-color: dodgerblue; !important;" class="header-bottom-area" id="fixheader">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <nav class="main-menu navbar navbar-expand-lg navbar-light" >
                        
                        <img src="{{asset('img/nstu_logo.png')}}" height="100" width="100" alt="Logo" />
                        ...
                        <div class="collapse navbar-collapse" id="menucontent">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li style="background-color: dodgerblue; !important;" class="nav-item dropdown">
                                ...
                                <li style="background-color: dodgerblue; !important;" class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button">Registration/Login</a>
                                    <ul  class="dropdown-menu">
                                        <li class="nav-item"><a class="nav-link" href="/login/admin">Administration</a></li>
                                        <li class="nav-item"><a class="nav-link" href="/login/student">Student</a></li>
                                        <li class="nav-item"><a class="nav-link" href="/login/alumni">Alumni</a></li>
...
<footer id="footer-area">
    <!-- Footer Widget Start -->
    <div style="padding: 35px" class="footer-widget bg-primary">
        <div class="container">
            <div class="row">
                <!-- Single Widget Start -->
                    ...
                    <div class="single-widget-wrap">
                        <div class="widgei-body">
                            <div class="footer-about">
                                <img src="{{asset('img/nstu_logo.png')}}"  height="100" width="100" alt="Logo" class="img-fluid" />
                                <!-- <p>Contact Info</p> -->
                                <br>
                                <a href="#"><i class="fa fa-fax"></i>Fax:02334496523 </a> <a href="#"><i class="fa fa-phone"></i>Telephone: 02334496522</a> <br> <a href="#"><i class="fa fa-envelope"></i>Email: info@nstu.edu.bd</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="footer-bottom-text">
                        <p>© {{ now()->year }} NSTU Alumni Association, All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
